...
layout = html.Div(
    className="page-container objective-page",  # added `objective-page` here
    children=[
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            "Analyze historical and current data to visualize trends in EV energy consumption, "
                            "illustrating the growth of EV adoption over time.",
                            className="card-text"
                        ),
                    ],
                ),
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            "Determine whether the cost of charging an EV provides a financial advantage over gasoline by "
                            "examining electricity rates, gas prices, and overall cost per mile.",
                            className="card-text"
                        ),
                    ],
                ),
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            "Provide insights into potential future energy consumption by EVs, including forecasts that "
                            "help stakeholders understand and prepare for shifts in demand.",
                            className="card-text"
                        ),
                    ],
                ),
